...
Route::group(['middleware' => ['auth:admin','CheckUserActiviation']], function(){ 
    ...
    Route::prefix('dashboard')->group(function () {
        ...
        Route::POST('trainers/store', [Admin\TrainerController::class, 'store'])->name('trainers.store');
        Route::post('trainers/update', [Admin\TrainerController::class, 'update'])->name('trainers.update');
        Route::get('invitations', [Admin\TrainerController::class, 'invitationsIndex'])->name('invitations.index');
...
Route::post('/admin/trainers/validate-subscription-code', [TrainerController::class, 'validateSubscriptionCode']);
Route::post('/admin/trainers/decrement-invitations', [TrainerController::class, 'decrementInvitations']);
