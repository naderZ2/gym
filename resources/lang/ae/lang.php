<?php 
	...
	return  [
		...
		"subscription_code_is_required" => "كود الاشتراك مطلوب",
		"invalid_subscription_code" => "كود الاشتراك غير صالح",
		"no_invitations_left" => "لا توجد دعوات متاحة",
		"expired_date" => " انتهت صلاحية الكود",
		...
		"invitations" =>"دعوات",
		"validate" =>"تحقق",
		"decrement_invitations" =>"استخدام الدعوات",
		"success_use_invitation" =>"تم استخدام الدعوة بنجاح",
		"add_trainers" =>"اضافة مدرب",
		"username" =>"اسم المستخدم",
		"invitations_count" =>"عدد الدعوات",
		"subscription_expiration" =>"تاريخ انتهاء الاشتراك",
		"phone_number" =>"رقم الهاتف",

		'The_id_is_required' => 'المعرف مطلوب',
		'The_id_must_exist_in_trainers_table' => 'المعرف يجب أن يكون موجودًا في جدول المدربين',
		'The_username_is_required' => 'اسم المستخدم مطلوب',
		'The_username_must_be_a_string' => 'اسم المستخدم يجب أن يكون نصًا',
		'The_username_may_not_be_greater_than_255_characters' => 'اسم المستخدم يجب ألا يزيد عن 255 حرفًا',
		'The_invitations_count_is_required' => 'عدد الدعوات مطلوب',
		'The_invitations_count_must_be_an_integer' => 'عدد الدعوات يجب أن يكون عددًا صحيحًا',
		'The_invitations_count_must_be_at_least_0' => 'عدد الدعوات يجب أن يكون على الأقل 0',
		'The_subscription_expiration_is_required' => 'تاريخ انتهاء الاشتراك مطلوب',
		'The_subscription_expiration_must_be_a_valid_date' => 'تاريخ انتهاء الاشتراك يجب أن يكون تاريخًا صالحًا',
		'The_subscription_expiration_must_be_today_or_later' => 'تاريخ انتهاء الاشتراك يجب أن يكون اليوم أو لاحقًا',
		'The_phone_number_is_required' => 'رقم الهاتف مطلوب',
		'The_phone_number_must_be_a_string' => 'رقم الهاتف يجب أن يكون نصًا',
		'The_phone_number_may_not_be_greater_than_15_characters' => 'رقم الهاتف يجب ألا يزيد عن 15 حرفًا',
		'The_phone_number_must_not_exceed_15_characters' => 'رقم الهاتف يجب ألا يزيد عن 15 حرفًا',
