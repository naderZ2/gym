<?php 
	return  [
		...
		"invalid_subscription_code" => "Invalid subscription code",
		"no_invitations_left" => "No invitations left",
		...
		"validate" => "Validate",
		"decrement_invitations" => "Use Invitations",
		"success_use_invitation" => "Invitation used successfully",
		"add_trainers" => "Add Trainer",
		"username" => "Username",
		"invitations_count" => "Number of Invitations",
		"subscription_expiration" => "Subscription Expiration Date",
		"phone_number" => "Phone Number",

		'The_id_is_required' => 'The ID is required',
		'The_id_must_exist_in_trainers_table' => 'The ID must exist in the trainers table',
		'The_username_is_required' => 'The username is required',
		'The_username_must_be_a_string' => 'The username must be a string',
		'The_username_may_not_be_greater_than_255_characters' => 'The username must not exceed 255 characters',
		'The_invitations_count_is_required' => 'The number of invitations is required',
		'The_invitations_count_must_be_an_integer' => 'The number of invitations must be an integer',
		'The_invitations_count_must_be_at_least_0' => 'The number of invitations must be at least 0',
		'The_subscription_expiration_is_required' => 'The subscription expiration date is required',
		'The_subscription_expiration_must_be_a_valid_date' => 'The subscription expiration date must be a valid date',
		'The_subscription_expiration_must_be_today_or_later' => 'The subscription expiration date must be today or later',
		'The_phone_number_is_required' => 'The phone number is required',
		'The_phone_number_must_be_a_string' => 'The phone number must be a string',
		'The_phone_number_may_not_be_greater_than_15_characters' => 'The phone number must not exceed 15 characters',
		'The_phone_number_must_not_exceed_15_characters' => 'The phone number must not exceed 15 characters',
